  ...
  clients: [
    {
      ...
      response_types: ["code"],
      redirect_uris: [
        "https://dss-app1.zenoncultural.com/signin-callback",
        "https://dss-app1.zenoncultural.com/silent-signin-callback",
      ],
      post_logout_redirect_uris: ["https://dss-app1.zenoncultural.com/home"],
      token_endpoint_auth_method: "none",
    },
    {
      client_id: "app2",
      // grant_types: ["implicit"],
      //Change to id_token to get an error
      response_types: ["code"],
      redirect_uris: [
        "http://localhost:4200/signin-callback",
        "http://localhost:4200/silent-signin-callback",
      ],
      post_logout_redirect_uris: ["http://localhost:4200/home"],
      token_endpoint_auth_method: "none",
    },
  ],
  interactions: {
